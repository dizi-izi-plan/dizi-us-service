...
v1_router.include_router(yandex_router, prefix="/auth/yandex", tags=["Yandex"])
v1_router.include_router(google_router, prefix="/auth/google", tags=["Google"])
v1_router.include_router(tariff_router, prefix="/tariff", tags=["Tariff"])
